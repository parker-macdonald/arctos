...
class NotFoundError(ArctosError):
    def __init__(self, message: str = "Not found", *, status_code: int = 404, public: bool = True):
        super().__init__(message=message, status_code=status_code, public=public)


class UnauthorizedError(ArctosError):
    def __init__(self, message: str = "Not authorized", *, status_code: int = 403, public: bool = True):
        super().__init__(message=message, status_code=status_code, public=public)


class ValidationError(ArctosError):
    def __init__(self, message: str = "Invalid input", *, status_code: int = 400, public: bool = True):
        super().__init__(message=message, status_code=status_code, public=public)


class RegistrationClosedError(ArctosError):
    def __init__(self, message: str = "Registration is not open", *, status_code: int = 400, public: bool = True):
        super().__init__(message=message, status_code=status_code, public=public)
